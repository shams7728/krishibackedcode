...
// Create a new variant & send WebSocket event
router.post('/', asyncHandler(async (req, res) => {
    ...
    try {
        ...
        req.io.emit('variant_created', newVariant);
...
// Update a variant & send WebSocket event
router.put('/:id', asyncHandler(async (req, res) => {
    ...
    try {
        ...
        // Emit WebSocket event for variant update
        req.io.emit('variant_updated', updatedVariant);
...
// Delete a variant & send WebSocket event
router.delete('/:id', asyncHandler(async (req, res) => {
    ...
    try {
        ...
        // Emit WebSocket event for variant deletion
        req.io.emit('variant_deleted', { variantID });
