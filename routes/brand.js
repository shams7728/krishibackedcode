...
// Create a new brand & send WebSocket event
router.post('/', asyncHandler(async (req, res) => {
    ...
    try {
        ...
        // Emit WebSocket event for new brand
        req.io.emit('brand_created', newBrand);
...
// Update a brand & send WebSocket event
router.put('/:id', asyncHandler(async (req, res) => {
    ...
    try {
        ...
        // Emit WebSocket event for brand update
        req.io.emit('brand_updated', updatedBrand);
...
// Delete a brand & send WebSocket event
router.delete('/:id', asyncHandler(async (req, res) => {
    ...
    try {
        ...
        // Emit WebSocket event for brand deletion
        req.io.emit('brand_deleted', { brandID });
