        ...
        uploadProduct.fields([
            ...
            fields.forEach((field, index) => {
                if (req.files[field] && req.files[field].length > 0) {
                    ...
                    const imageUrl = `https://krishibackedcode.onrender.com/uploads/products/${file.filename}`;
    ...
    try {
        ...
        uploadProduct.fields([
            ...
            fields.forEach((field, index) => {
                if (req.files[field] && req.files[field].length > 0) {
                    const file = req.files[field][0];
                    const imageUrl = `http://console.log('Creating new product...');
...
console.log('Error updating product:', err);https://krishibackedcode.onrender.com/uploads/products/${file.filename}`;
