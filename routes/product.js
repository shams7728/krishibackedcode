        ...
        uploadProduct.fields([
            ...
            fields.forEach((field, index) => {
                if (req.files[field] && req.files[field].length > 0) {
                    ...
                    const imageUrl = `http://192.168.0.201:3000/image/products/${file.filename}`;
...
console.log('Error updating product:', err);192.168.0.201:3000/image/products/${file.filename}`;
